      ...
      <div className="main">
        <div className="container-boxes">
          <div className={`container-doacao ${expanded ? "expanded" : ""}`} onClick={toggleExpansion}>
            ...
            {expanded && (
              <div className="additional-content">
                <p className="text-p">Ajude-nos a tornar nosso próximo evento na igreja um sucesso com sua contribuição. Seu apoio é a chave para fortalecermos os momentos de fé!</p>
          ...
          <div className={`container-doacao ${expanded ? "expanded" : ""}`} onClick={toggleExpansion}>
            ...
            {expanded && (
              <div className="additional-content">
                <p className="text-p">Seja voluntário no próximo evento da igreja e faça a diferença em nossa comunidade. Sua ajuda é valiosa, e juntos construímos um ambiente unido e amoroso!</p>
                <div  className="div-link">
