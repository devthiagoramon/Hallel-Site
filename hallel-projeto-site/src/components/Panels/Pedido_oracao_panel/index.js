  ...
  return (
    ...
    <div className="pedido-container">
      ...
      <div className="container-imagem">
        ...
        <img src="https://www.basilicacoracaodemaria.com/area/img/noticias/6f7757f890370ad6cd8c9d062b5bac4c.jpg" alt="homem doando, imagem"></img>
        ...
        <div className="info-conteudo">
          ...
          <button>  <Link id="textBt" to="/pedido">Enviar</Link>
        </button>
