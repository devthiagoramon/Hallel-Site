...
// import {okenService} from "../../service/HomeService";
...
const HeaderHallel = () => {
    ...
    //     verificarTokenService(localStorage.getItem("token")).then((response) => {
    //         if (response) {
    //             localStorage.clear();
    //             setIsExpired(true);
    //         } else {
        ...
        <>
            <header className="header_hallel">
                <div className="cont_imagem_hallel">
                    <img className={"imagem_hallel"} alt={"Logo Hallel"}/>
                ...
                {openMenu && <nav>
                    <ul>
                        ...
                        <li><Link to={"/"}>Ministérios</Link></li>
                        <li>
                        ...
                        <li>
                            ...
                            <CgProfile onClick={handleClickPerfil} className="icon_perfil_header" size={32}/>
                        </li>
                    </ul>
                </nav>}
            </header>
