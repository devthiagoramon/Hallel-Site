...
const ModalEditDespesaEvento = (props) => {
    ...
    const { idEvento, despesaSelected, openModal, setOpenModal, setEditarPopUp, setOpenPopUp } = props;

    const [despesaEvento, setDespesaEvento] = useState(despesaSelected);
    ...
    const editarDespesaEvento = () => {
        ...
        setEnviando(true);
        axios.put("http://localhost:8080/api/administrador/eventos/" + idEvento + "/despesa/" + despesaEvento.id + "/edit", {
            ...despesaEvento
        }, {
            headers: {
