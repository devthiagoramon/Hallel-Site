...
const InputsBodyDespesasEvento = (props) => {
  ...
  const adicionarDespesaEmEvento = () => {
    setEnviando(true);
    eventoAddDespesasParaEventoPorIdService(idEvento, despesaEvento).then(
      (response) => {
        if (response) {
          setEnviando(false);
          setenviado(true);
  ...
  return (
    <div className="container_inputs_despesas_evento">
      <div className="inputs_despesas_evento">
        <label className="inputs_despesas_evento_rotulo">
          Adicionar Despesa
        </label>
        <label>
            ...
            <>
              {enviando === false ? (
                <Button
                  variant="contained"
                  endIcon={<AddRounded />}
                  onClick={adicionarDespesaEmEvento}
                >
                  Adicionar
                </Button>
              ) : (
