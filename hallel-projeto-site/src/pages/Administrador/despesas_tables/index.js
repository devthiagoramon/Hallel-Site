...
function createDataRendas(id, codigo, data, valor, metodoPagamento) {
  return { id, codigo, data, valor, metodoPagamento };
}
  ...
  return (
    <div className="tabela-ultimas-rendas">
      <div className="div-rendas">
        <label className="financeiro-labels">Últimas Entradas</label>
        <Fab
          size="small"
          color="white"
          aria-label="avançar"
            ...
            {entradas.map((entrada) => (
              ...
              >
                <TableCell component="th" scope="row">
                  {entrada.codigo !== null && entrada.codigo.nomeCodigo}
                </TableCell>
                <TableCell>
