...
const HistoricoAssociado = () => {
    ...
    useMemo(() => {
        listAssociadoByIdAdmService(idAssociado).then((response) => {
            setAssociadoObj(response);
        });
    }, []);
    ...
    function loadFromAPIinfoByPagamentoByMesAndAno(date) {
        ...
        getPagamentoAssociadoByMesAnoAdmService(idAssociado, mes, ano).then((response) => {
