  ...
  return (
    ...
    <div className = "loc">
      ...
      <div className = "texto">
        ...
        <p>
          Clenir Viana Guimarães, nascida na Cidade de Parintins, veio à Manaus para cursar faculdade de Administração. Trabalha no Tribunal de Contas da União.</p>

<p>Participou da Renovação Carismática desde os 13 anos. Coordenou a Secretaria Davi e a Secretaria Paulo Apóstolo na RCC, participou do Conselho Diocesano da RCC, representou os Movimentos e as Comunidades de Vida na Assembléia Pastoral Arquidiocesana; estudou Teologia no Instituto de Teologia, Pastoral e Ensino Superior - ITEPES.</p>

<p>Atendendo ao chamado de Deus em seu coração e seguindo o impulso do Espírito Santo deu início à Comunidade Católica Hallel partir de seu trabalho como Coordenadora do Ministério de Música Hallel, até então pertencente a RCC.</p>
