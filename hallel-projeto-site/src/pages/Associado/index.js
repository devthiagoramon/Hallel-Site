...
function TopoConteudo() {
  return (
    <section className="conteudo-top">
      ...
      <label>
        Seja um associado Hallel, faça parte dos nossos projetos, tenha acesso
        aos cursos, certificados e outros benefícios
      </label>
    </section>
  );
}
    ...
    <section className="imagem-top">
      <div className="containerCircular">
        <div>
          ...
          <label>
            Ajude a comunidade a continuar crescendo, seja um apoiador!
          </label>
  ...
  return (
    <section className="informacoes-associado">
      <div className="inftexto-Associado">
        Fique por dentro e receba palavras especiais.
      </div>
      <div className="inftexto-Associado">
      ...
      <div className="inftexto-Associado">
        ...
        letters, and more recently with desktop publishing software
      </div>
    </section>
  );
}
...
function Associado() {
  return (
    <section id="body-associado">
      ...
      <label id="infcont">
        Alguma dúvida?<span> Entre em contato conosco</span>
      </label>
    </section>
  );
}
